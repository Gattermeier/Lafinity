...
$(function(){
    ...
    var html=
        '<div id="54ad55f9f1e7a9bb6e000001" class="modal fade"><div class="modal-dialog"><div class="modal-content">'
    ...
    function eoymodal() {
        ...
        var today = new Date();
        if ((active === true) && ($.cookie('54ad55f9f1e7a9bb6e000001') == null) && (enddate>today)) {
            $('#<%MODALID%>').modal('show');
