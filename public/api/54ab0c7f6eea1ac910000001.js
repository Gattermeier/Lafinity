...
$(function(){
    ...
    var html=
        '<div id="54ab0c7f6eea1ac910000001" class="modal fade"><div class="modal-dialog"><div class="modal-content">'
    ...
    function eoymodal() {
        ...
        var today = new Date();
        if ((active === true) && ($.cookie('54ab0c7f6eea1ac910000001') == null) && (enddate>today)) {
            $('#<%MODALID%>').modal('show');
